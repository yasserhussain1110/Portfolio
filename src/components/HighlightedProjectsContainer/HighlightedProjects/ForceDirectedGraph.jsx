...
const forceDirectGraph = d3Projects[1];
...
const ForceDirectedGraph = ({showing}) => (
  ...
  >
    ...
    <div className="col-xs-offset-2 col-xs-8 img-container">
      <img alt="Force Directed Graph" src={forceDirectGraph.bgImageUrl} />
    </div>
